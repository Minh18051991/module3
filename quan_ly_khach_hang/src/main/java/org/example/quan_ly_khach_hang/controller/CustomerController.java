...
import org.example.quan_ly_khach_hang.service.ICustomerService;
...
public class CustomerController extends HttpServlet {
    ...
    private void deleteCustomer(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (customer == null) {
            dispatcher = request.getRequestDispatcher("webapp/WEB-INF/404-jsp.jsp");
        } else {
    ...
    private void updateCustomer(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (customer == null) {
            ...
            dispatcher = request.getRequestDispatcher("/customer_update.jsp");
        }
        try {
    ...
    private void createCustomer(HttpServletRequest request, HttpServletResponse response) {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/customer_add.jsp");
    ...
    private void viewCustomer(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (customer == null) {
            ...
            request.setAttribute("customer", customer);
            dispatcher = request.getRequestDispatcher("webapp/WEB-INF/view.jsp");
        }
        try {
            dispatcher.forward(request, response);
        } catch (ServletException e) {
    ...
    private void showDeleteForm(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (customer == null) {
            ...
            request.setAttribute("customer", customer);
            dispatcher = request.getRequestDispatcher("webapp/WEB-INF/delete.jsp");
        }
        try {
            dispatcher.forward(request, response);
        } catch (ServletException e) {
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (customer == null) {
            ...
            request.setAttribute("customer", customer);
            dispatcher = request.getRequestDispatcher("webapp/WEB-INF/customer_update.jsp");
        }
        try {
            dispatcher.forward(request, response);
        } catch (ServletException e) {
    ...
    private void showCreateForm(HttpServletRequest request, HttpServletResponse response) {
        RequestDispatcher dispatcher = request.getRequestDispatcher("webapp/WEB-INF/customer_add.jsp");
        try {
            dispatcher.forward(request, response);
        } catch (ServletException e) {
            e.printStackTrace();
    ...
    private void listCustomers(HttpServletRequest request, HttpServletResponse response) {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("webapp/WEB-INF/customer_list.jsp");
        try {
            dispatcher.forward(request, response);
        } catch (ServletException e) {
            e.printStackTrace();
